...
@Controller
@RequestMapping("/file")
public class FileRountingController {

    private static Logger log = Logger.getLogger(FileRountingController.class);
...
//        return ext.substring(1,ext.length());
    ...
    private String getDomain() {
        try {
            ...
            InputStream in = FileRountingController.class.getResourceAsStream(propFileName);
            prop.load(in);
