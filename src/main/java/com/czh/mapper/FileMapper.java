...
public interface FileMapper {
    ...
    @Insert("insert into tb_file(uid, filename, url, md5, status, type, size, parsonPath, parsonId, time) values(#{uid}, #{filename}, #{url}, #{md5}, #{status}, #{type}, #{size}, #{parsonPath}, #{parsonId}, #{time})")
